 ...
 * 
 * WS2_2.Tree class defines a recursive type called WS2_2.Tree (for Binary Trees),
 * and provides constructor and getter methods.  
 *
 * The original WS2_2.Tree class is modified here with an additional field
...
public class Tree<E> {
    ...
    /**
     * WS2_2.Tree class defines a recursive type called WS2_2.Tree, and provides
    ...
    /**
     * Creates a new WS2_2.Tree with root value and left and right
     * subtrees.
     */
     ...
     * Creates a multi-line String that represents this WS2_2.Tree. The
